...
<body>
    ...
    <script>
        $(document).ready(function() {
            var linkSearch = 'https://timkiem.vnexpress.net/?q='
            $('.search-model-form').submit(function(e) {
                e.preventDefault();
                var searchInput = $('#search-input').val();
                var changeSearchValue = encodeURIComponent(searchInput).replace(/%C4%91/g, '%C4%91');
                console.log(changeSearchValue);
                window.location=linkSearch+changeSearchValue;
            })
        })
    </script>
