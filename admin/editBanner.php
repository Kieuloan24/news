                  ...
                  <?php if ($result->num_rows > 0) {
                        ...
                        ?>
                                <tr>
                                    ...
                                    <?php if($row['status'] == 1)
                                        {?>
                                        <a href="bannerManager.php?id=<?php echo $row['banner_id'];?>" onclick="return confirm('Bạn có chắc chắn muốn dừng quảng cáo này?');" >  <button class="btn btn-danger">Block</button>
                                        <?php } else {?>
                                        <a href="bannerManager?id=<?php echo $row['banner_id'];?>" onclick="return confirm('Bạn có chắc chắn muốn kích hoạt quảng cáo này?');"><button class="btn btn-primary">Active</button> 
                                        <?php } ?>
