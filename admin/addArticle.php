    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="modal-body">
                <form action ="uploadarticle.php" method="POST" id="myform" enctype="multipart/form-data">
                ...
                <div class="form-group">
                        ...
                        <div class="right-wrap-field"><input type="text" class="form-control" name="title" id="title" placeholder="Enter title"></div>
                    </div>
                    <div class="form-group">
