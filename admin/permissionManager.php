        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">PERMISSION MANAGER</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="card">
              <div class="row">
                        <div class="col-12 d-flex justify-content-end">
                            <button type="button" class="btn btn-primary"><a style="color: black;" href="addPermission.php">Add Permission</a></button>
                        </div>
                    </div>
              <!-- ./card-header -->
              <div class="card-body">
                  ...
                  <?php if ($result->num_rows > 0) {
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><a href="editPermission.php?id=<?php echo $row['permission_id']; ?>" class="btn btn-warning">Edit</a>
                                    <a href="deletePermission.php?id=<?php echo $row['permission_id']; ?>"  onclick="return checkDelete()" class="btn btn-danger">Delete</a>
                                </td>
