...
if (isset($_GET['id'])) {
    ...
    $idParent =  $row['permission_id'];
    $sql1 =  "SELECT `name` FROM `account` WHERE `id` = $idParent;";
    $nameParent = mysqli_query($conn, $sql1);
    $row2 = $nameParent->fetch_assoc();
...
?>
 <?php
    if (isset($_POST['name'])) {
        ...
        $sql = "UPDATE `account` SET `name`='$name',`phonenumber`='$phonenumber',`username`='$username',`password`='$password', `permission_id` = $permissionid WHERE id = $id";
        $result = mysqli_query($conn, $sql);
        mysqli_close($conn);
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="editAccount.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Edit Account</p>
                                    </a>
                                </li>
            ...
            <div class="modal-body">
                <form acction ="" method="POST" id="myform">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" value="<?php echo " $row[name]" ?>" name="name" aria-describedby="emailHelp" placeholder="Enter name">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Phone Number</label>
                                    <input type="text" class="form-control" value="<?php echo " $row[phonenumber]" ?>" name="phonenumber" placeholder="Enter phonenumber">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo " $row[password]" ?>" name="password" placeholder="Enter password">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">PermissionID</label>
                                    <select name="permission_id" id="">
                                        <option value="<?php if(isset($row['permission_id']))
                                                {
                                                    echo " $row[permission_id]";
                                                } else { echo"" ;} ?>">
                                            <?php 
                                            if(isset($row2['name'])) {echo " $row2[name]";} else {echo"---Select---";}
                                            ?></option>
                                        <?php
                                            $parent = "SELECT * FROM `permission`";
                                            $parentResult = mysqli_query($conn, $parent);
                                            if($parentResult->num_rows > 0){
                                            while ($data = $parentResult->fetch_assoc()) {
                                        ?>
                                            <option value="<?php echo " $data[permission_id]" ?>"> <?php echo " $data[name]" ?> </option>
                                        <?php
                                            }
