            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="accountManager.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Account List</p>
                                    </a>
                                </li>
                  ...
                  <?php if ($result->num_rows > 0) {
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><a href="editAccount.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a>
                                    <a href="deleteAccount.php?id=<?php echo $row['id']; ?>"  onclick="return checkDelete()" class="btn btn-danger" >Delete</a>
                                </td>
