...
if (isset($_POST['name'])) {
    ...
    $insertAccount= "INSERT INTO `account`(`name`, `phonenumber`, `username`, `password`, `permission_id`) VALUES ('$name','$phonenumber','$username','$password','$permissionid')";
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="./addAccount.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add Account</p>
                                    </a>
                                </li>
            ...
            <div class="modal-body">
                <form acction ="" method="POST" id="myform">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" aria-describedby="emailHelp" placeholder="Enter name" autocomplete="off"  required/>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Phone Number</label>
                        <input type="text" class="form-control" name="phonenumber" id="phonenumber" placeholder="Enter phone number" autocomplete="off"  required />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="permission_id" id="" required="required">
