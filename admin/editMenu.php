...
if (isset($_GET['id'])) {
    ...
    $idParent =  $row['menu_parent_id'];
    $sql1 =  "SELECT `menu_title` FROM `menu` WHERE `menu_id` = $idParent;";
...
?>
 <?php
    if (isset($_POST['menutitle'])) {
        ...
        $sql = "UPDATE `menu` SET `menu_title`='$menutitle',`menu_link`='$menulink', `menu_parent_id` = $parent WHERE menu_id = $id";
        $result = mysqli_query($conn, $sql);
        mysqli_close($conn);
            ...
            <div class="modal-body">
                <form acction ="" method="POST" id="myform">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" value="<?php echo " $row[menu_title]" ?>" name="menutitle" aria-describedby="emailHelp" placeholder="Enter name Menu">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Menu Link</label>
                                    <input type="text" class="form-control" value="<?php echo " $row[menu_link]" ?>" name="menulink" placeholder="Enter menu link">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Parent</label>
                                    <select name="parent" id="">
                                        <option value="<?php if(isset($row['menu_parent_id']))
                                                {
                                                    echo " $row[menu_parent_id]";
                                                } else { echo"" ;} ?>">
                                            <?php 
                                            if(isset($row2['menu_title'])) {echo " $row2[menu_title]";} else {echo"---Select---";}
                                            ?></option>
                                        <?php
