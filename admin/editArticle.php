...
?>
 <?php
    if (isset($_POST['title'])) {
        ...
        $images = $_POST['images'];
        $link = $_POST['link'];
        $sql = "UPDATE `article` SET `title`='$title', `id_category`='$categoryId', `images`='$images', `link`='$link' WHERE id = $id";
        $result = mysqli_query($conn, $sql);
        mysqli_close($conn);
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Article Manager</a></li>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                                    ...
                                    <select name="category" id="">
                                        <option value="<?php if(isset($row['id_category']))
                                                {
                                                    echo " $row[id_category]";
                                                } else { echo"" ;} ?>">
                                            <?php 
                                            if(isset($row2['category'])) {echo " $row2[category]";} else {echo"---Select---";}
                                            ?></option>
                                        <?php
                                            $parent = "SELECT * FROM `category`";
                                            $parentResult = mysqli_query($conn, $parent);
                                            if($parentResult->num_rows > 0){
                                            while ($data = $parentResult->fetch_assoc()) {
                                        ?>
                                            <option value="<?php echo " $data[category_id]" ?>"> <?php echo " $data[category]" ?> </option>
                                        <?php
                                            }
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo " $row[title]" ?>" name="title" placeholder="Enter Title">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Image</label>
                                    <td><img src="image/<?php echo "$row[images]";?>"></td>
                                    <input type="hidden" name="images" value="<?php echo "$row[images]";?>">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Link</label>
                                    <input type="text" class="form-control" value="<?php echo " $row[link]" ?>" name="link" placeholder="Enter Link">
                                </div>
